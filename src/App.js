...
class App extends React.Component {
  ...
  constructor(props) {
    ...
    var PlayerProbsOrder = Array(blockNumTotal);
    var PlayerProbs = [20, 60, 80]; 
  ...
  handleBlame(keyPressed, timePressed) {
    ...
    if  (whichButton === 3 && this.state.BlameLevel !== null) {
      var blameTime = timePressed - [
        ...
        var blame; 
        if (this.state.correct === 1 && PlayerCorrect === 1) {
          blame = 0;
        } else if (this.state.correct === 0 && PlayerCorrect === 0) {
          blame = 1; 
        } else if ((this.state.correct === 0 && PlayerCorrect === 1) || (this.state.correct === 1 && PlayerCorrect === 0)) {
          blame = 2;
        };
  ...
  render() {
    ...
    if (this.state.debug === false) {
      ...
      {
        if (this.state.blame === 0) {
          text = (<div>
            <center>
                Rate if you believe your answer or the other player´s choice to be the correct one. 
                If you think your choice was correct you should move the slider to the right. 
              </center>
              <br />
              <br />
              <br />
        ...
        text = (
          ...
          <center>
            ...
            <br />
          <center> 
            <DrawBlame.DrawBlame choice={this.state.choice} />
            </center>
            <br />
            <br />
            <br />
